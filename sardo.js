...
module.exports = {
	rep: msg => {
		...
		else if (msg.content.toLowerCase() === 'sdoch') {
			msg.reply('O');
		}
		else if (msg.content.toLowerCase() === 'ascii') {
			msg.reply('flemme')
		}
		else if (msg.content.toLowerCase() === 'non') {	
			msg.reply('https://www.youtube.com/watch?v=caXgpo5Ezo4');
		}
		else if (msg.content.toLowerCase().includes('rick')) {
			msg.reply('https://www.youtube.com/watch?v=dQw4w9WgXcQ');
		}
		else if (msg.content.toLowerCase().includes('solary')) {
			msg.reply('Dans 3 mois top chrono on baise Solary !');
		}
		else if (msg.content.toLowerCase().includes('bucheron') || msg.content.toLowerCase().includes('bûcheron')) {
			msg.reply('JE SUIS UN CHASSEUR DE BOIS');
		}
		else if (msg.content.startsWith('!delete') && (msg.author.username === "PikaStreamx" || msg.author.username === "Azaeps 🔥")) {
